package com.ranger.xyg.demos.permission;
...
public class PermissionDemoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showToast(String text) {
        Toast.makeText(PermissionDemoActivity.this, text, Toast.LENGTH_SHORT).show();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn1:
                ...
                HiPermission.create(PermissionDemoActivity.this)
...
//                        .style(R.style.CusStyle)
            ...
            case R.id.btn4:
                ...
                HiPermission.create(PermissionDemoActivity.this).checkSinglePermission(Manifest.permission.CAMERA, new PermissionCallback() {
                    @Override
                    public void onClose() {
